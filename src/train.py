...
# training settings
gamma:float = 1.0 # prioritizes between current (immediate, in this next step) rewards and future rewards... 0.0 = full prioritization on current rewards, 1.0 = future values just as important as immediate, and > 1.0 means future rewards mean even more
