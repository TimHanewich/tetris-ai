...
games_in_episode:int = 200 # how many games will be played (simulated), with the top X% being used to train
...
epsilon_decay:float = 0.03 # how much to decrease epsilon after each training
