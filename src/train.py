...
games_in_episode:int = 100 # how many games will be played (simulated), with the top X% being used to train
train_on_best_count:int = 25 # the number of TOP games (games that will be trained on) which will be trained on out of the episode
training_epochs:int = 15 # the number of epochs those accrued good games are trained on
